...

{
  ...
  "emulator"."29.2.6".macosx = {
    ...
    archives = {
      macosx = fetchurl {
        url = https://dl.google.com/android/repository/emulator-darwin-5959125.zip;
        sha1 = "190a4a1e7037baa5a54fa01e03f5f1ae9c669c31";
      };
      linux = fetchurl {
        url = https://dl.google.com/android/repository/emulator-linux-5959125.zip;
  ...
  "ndk-bundle"."21.0.5935234" = {

    name = "ndk-bundle";
    path = "ndk-bundle";
    revision = "21.0.5935234";
    displayName = "NDK";
    archives = {
      macosx = fetchurl {
  ...
  "platforms"."29" = {
    ...
    archives = {
        ...
        all = fetchurl {
          url = https://dl.google.com/android/repository/platform-29_r01.zip;
  ...
  "skiaparser"."1-rc01" = {
    ...
    archives = {
      linux = fetchurl {
        url = https://dl.google.com/android/repository/skiaparser-5924912-linux.zip;
        sha1 = "562006934072f422770992af853884f7dd0f8d59";
      };
      macosx = fetchurl {
        url = https://dl.google.com/android/repository/skiaparser-5924912-mac.zip;
